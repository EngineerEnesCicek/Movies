...
import com.example.movie.databinding.FragmentThisWeekTrendBinding
import com.example.movie.core.functions.itemClicked
import com.example.movie.data.entitiy.MixModel

class ThisWeekTrendFragment : Fragment(), SelectListener {
    private lateinit var navController: NavController
    lateinit var binding: FragmentThisWeekTrendBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentThisWeekTrendBinding.inflate(layoutInflater, container, false)
        recyclerView = this.binding.thisWeekTrendsRecyclerView
        recyclerView.layoutManager =
            LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false)
        movieListViewModel = ViewModelProvider(this)[MovieListViewModel::class.java]
        movieListViewModel.getTrendThisWeek()
